    ...
    return "\
        <table id='" + this.id("wrapper") + "' class='mgslider-wrapper' border='0'>\
            ...
            <tr class='mgslider-feedback'>\
                <td id='" + this.id("show") + "' class='mgslider-show' colspan='3'><i>" + this.yourvalue + "</i> <b><span id='" + this.id("cur") + "' class='mgslider-value'></span></b> <i> jetons </i></td>\
            </tr>\
        </table>\
        \
